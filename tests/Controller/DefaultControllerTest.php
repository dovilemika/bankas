...
class DefaultControllerTest extends WebTestCase
{
     ...
     * account post fixtures are randomly generated and there's no guarantee that
     * a given account post slug will be available.
     */
    public function testPublicBlogPost(): void
    {
        ...
        $client->request('GET', sprintf('/en/account/posts/%s', $blogPost->getSlug()));
