 ...
 * for managing the account in the backend.
 *
...
class BlogControllerTest extends WebTestCase
{
    ...
    /**
     * This test changes the database contents by creating a new account post. However,
    ...
    public function testAdminNewDuplicatedPost(): void
    {
        ...
        $this->assertSelectorTextContains('form .form-group.has-error .help-block', 'This title was already used in another account post, but they must be unique.');
    }
    ...
    /**
     * This test changes the database contents by editing a account post. However,
     * thanks to the DAMADoctrineTestBundle and its PHPUnit listener, all changes
     * to the database are rolled back when this test completes. This means that
     * all the application tests begin with the same database contents.
     */
    ...
    /**
     * This test changes the database contents by deleting a account post. However,
     * thanks to the DAMADoctrineTestBundle and its PHPUnit listener, all changes
     * to the database are rolled back when this test completes. This means that
     * all the application tests begin with the same database contents.
     */
