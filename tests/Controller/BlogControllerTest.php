...
/**
 * Functional test for the controllers defined inside AccountController.
 *
...
class BlogControllerTest extends WebTestCase
{
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/en/account/rss.xml');
    ...
    {
        $client = static::createClient();
        $client->xmlHttpRequest('GET', '/en/account/search', ['q' => 'lorem']);
